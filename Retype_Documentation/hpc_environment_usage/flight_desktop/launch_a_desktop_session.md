...
Users need a VNC client to connect to the graphical desktop session - for a list of tested clients, see [Prerequisites](/overview/prerequisites/#prerequisites).
